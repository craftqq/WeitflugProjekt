...
public class GameLoop 
{
	...
	public void erzeugeNeuesSpielObjekt()
	{
		...
		if(objektInt == 1)
		{
			objekte.add(new Coin(500, GameEngine.random.nextInt(200)));
		}
		else
		{
			objekte.add(new Hinderniss(500, GameEngine.random.nextInt(200)));
		}
	}
}
