...
public class Kreis implements IComponente {
    ...
    public void setzeMittelpunkt(double neuesMX, double neuesMY) {
        setzeMittelpunkt((int) neuesMX, (int) neuesMY);
    }
    ...
    public void setzeMittelpunktUndRadius(double neuesMX, double neuesMY,
    double neuerRadius) {
        setzeMittelpunktUndRadius((int) neuesMX, (int) neuesMY,
            (int) neuerRadius);
    }
